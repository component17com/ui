<template>
    <div class="container-fluid headerDev-bck">
        <div class="container headerDev-container">
            <header class="headerDev">
                <div class="headerDev__logo">
	...
	<g id="_x35_c10b948-7f96-42b1-8221-e59b924b3d0d">
		<g>
			...
			<g>
                ...
                <div class="headerDev__menu">
                    <el-dropdown :hide-on-click="false" trigger="click">
                        <el-button class="headerDev__menu-button el-dropdown-link">
                            <img src="static/images/avatar.png" alt="" class="headerDev__menu-button-img">
							<i class="el-icon-caret-bottom"></i>
                        </el-button>
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item class="head-dropdown-item">
								<el-button class="dropdown__butt"><i class="mdi mdi-view-dashboard"></i>Панель управления</el-button>
							</el-dropdown-item>
							<el-dropdown-item class="head-dropdown-item">
								<el-button class="dropdown__butt"><i class="mdi mdi-monitor"></i>Конфигурации</el-button>
							</el-dropdown-item>
							<el-dropdown-item divided class="head-dropdown-item">
								<el-button class="dropdown__butt"><i class="mdi mdi-exit-to-app"></i>Выйти из аккаунта</el-button>
							</el-dropdown-item>
						</el-dropdown-menu>
                    </el-dropdown>
                </div>
