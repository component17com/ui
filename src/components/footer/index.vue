<template>
    <footer class="footer">
        <div class="container-fluid footer-container-top">
            <div class="container">
			...
			<g>
				...
				<path class="st1" d="M165.7,10.3h4l0.1,1.8c0.6-0.6,1.2-1.1,1.9-1.5c0.8-0.4,1.6-0.7,2.5-0.7c0.3,0,0.5,0,0.8,0.1l-0.3,4.2
                    ...
                    <div class="footer__top-nav">
                        <a href="" title="" class="footer__nav-a">Документация</a>
                        <a href="" title="" class="footer__nav-a">Документация к модулям</a>
                        <a href="" title="" class="footer__nav-a">FAQ</a>
                        <a href="" title="" class="footer__nav-a">Поддержка</a>
                        <a href="" title="" class="footer__nav-a">Перейти в Ustore</a>
                        <a href="" title="" class="footer__nav-a">Cкачать Upoint</a>
                    </div>
                </div>
            </div>
        </div>
